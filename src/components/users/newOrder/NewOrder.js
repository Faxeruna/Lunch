...
export default class HomePage extends Component {
  ...
  createOrder(e) {
    if (this.state.new_order) {
      axios({
        method: "post",
        url: "https://simbirsoftlearning.cleverapps.io/api_lunch_system.php?mode=create_order",
        data: {
  ...
  componentDidMount() {
    axios({
      method: "post",
      url: "https://simbirsoftlearning.cleverapps.io/api_lunch_system.php?mode=get_catalog",
      data: {
        session_token: USER[0].session_token
      }
    })
